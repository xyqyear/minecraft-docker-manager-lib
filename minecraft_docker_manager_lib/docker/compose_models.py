...
#   timestamp: 2024-10-25T05:34:06+00:00
...
class Logging(BaseModel):
    ...
    options: Mapping[str, str | float | None] | None = None
...
class ConfigItem(BaseModel):
    ...
    aux_addresses: Mapping[str, str] | None = None
...
class Build(BaseModel):
    ...
    args: (
        Mapping[str, str | float | bool | None] | Sequence[str] | None
    ) = None
    ssh: (
        Mapping[str, str | float | bool | None] | Sequence[str] | None
    ) = None
    ...
    extra_hosts: (
        Mapping[str, str | Sequence[Any]] | Sequence[str] | None
    ) = None
    isolation: str | None = None
    privileged: bool | str | None = None
    secrets: Sequence[str | ServiceConfigOrSecret1] | None = None
    tags: Sequence[str] | None = None
    ulimits: Mapping[str, int | str | Ulimits1] | None = None
...
class Networks(BaseModel):
    ...
    driver_opts: Mapping[str, str | float] | None = None
...
class Service(BaseModel):
    ...
    cpu_count: str | int | None = None
    cpu_percent: str | int | None = None
    ...
    depends_on: (
        Mapping[str, DependsOn] | Sequence[str] | None
    ) = None
    ...
    networks: (
        Mapping[str, Networks | None]
        | Sequence[str]
        | None
    ) = None
    oom_kill_disable: bool | str | None = None
    oom_score_adj: str | int | None = None
    pid: str | None = None
...
class ComposeSpecification(BaseModel):
    ...
    volumes: Mapping[str, Volume | None] | None = None
